...
public class SubjectController {
    ...
    public ResponseEntity<?> getTeachersBySubject(@PathVariable("id") Integer subjectId) {
        return ResponseEntity.ok(Map.of("teachers", subjectService.getTeachersBySubjectId(subjectId)));
    }
