...
public class AttendanceController {
    ...
    public ResponseEntity<?> getAttendance(
        ...
        // Sử dụng DTO view để tránh lỗi 500 No Session cho học sinh/phụ huynh
        if (studentId != null && date != null && !date.isBlank()) {
            return ResponseEntity.ok(attendanceService.getAttendanceForStudentView(studentId, date));
        }
