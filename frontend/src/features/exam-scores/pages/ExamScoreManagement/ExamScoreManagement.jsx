            ...
            <table className="admin-grade-table min-w-full border-collapse text-sm">
              ...
              <tbody>
                {filteredRows.length === 0 ? (
                  <tr>
                      <td colSpan={outerTableColSpan} className="border border-slate-200 px-4 py-8 text-center text-slate-500">
...
const ExamScoreManagement = () => {
  ...
  const outerTableColSpan = (isParent ? 0 : 2) + 4 + 1 + (!isViewOnly && !isAdmin ? 1 : 0);
                  ...
                  {scoreGroups.map((group, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {!isParent && <td className="border border-slate-200 px-2 py-2">{group.classEntity?.name}</td>}
                        {(isViewOnly || teacherOuterShowOral) && (
